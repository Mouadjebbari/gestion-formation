        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    ?>
                    <a href="#categorie" id="z" class="nav-item nav-link">Categorie</a>
                    <a href="#COURS" id="a"class="nav-item nav-link ">Formation</a>
...
<!-- Courses Start -->
            <div class="text-center mb-5" id="COURS">
...
if(isset($_GET['search_query'])) {
    ...
    $query = "SELECT * FROM formation WHERE sujet LIKE :search_query";
  ...
  ?>
   <div class="col-lg-4 col-md-6 mb-4" >
    ...
    <img class="card-img-top w-100" style="height: 200px;" src="<?php echo $row['image']; ?>" alt="">        <div class="bg-secondary p-4">
            <div class="d-flex justify-content-between mb-3">
                <small class="m-0" style="border-top:2px solid #FF6600;border-bottom:2px solid #FF6600;padding:5px;"><i class=""></i> <?php echo $row['categorie'];?></small>
            ...
            <div class="border-top mt-4 pt-4">
                <div class="d-flex justify-content-between">
                    ...
                    ?>
                    <a href="about.php" class="btn btn-primary py-md-2 px-md-4 font-weight-semi-bold mt-2" met>Connectez-vous</a>
                    <?php
                    }
                    ?>
                </div>
