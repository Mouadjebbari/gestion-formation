...
$stmt = $conn->query("SELECT * FROM apprenant WHERE email = '" . $email. "' and password = '" . md5($password). "'"); 
...
$_SESSION['user_id'] = $result[0]['id_apprenant'];
                ...
                <div class="col-lg-8">
                    <div class="contact-form bg-secondary rounded p-5">
                        ...
                        <form method="POST" name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                <input type="password" name="password" class="form-control border-0 p-4" id="subject" placeholder="Mot De Passe" required="required" data-validation-required-message="Please enter a subject" />
                                <p class="help-block text-danger"></p>
                            </div>
                            ...
                            <a href="register.php" class="nav-item nav-link active">nouveau ici ? S'INSCRIRE.</a>
                        </form>
                    </div>
                </div>
            </div>
