    ...
    <body>
            ...
            <section class="home-section">
                ...
                <div class="container rounded bg-white mt-5 mb-5">
                    ...
                    <?php
$stmt = $conn->prepare("SELECT formation.id_formation, formation.sujet, formation.categorie, formation.masse_horaire, formation.description, formation.image, session.id_session, session.date_debut, session.date_fin FROM inscription JOIN session ON inscription.id_session = session.id_session JOIN formation ON session.id_formation = formation.id_formation WHERE inscription.id_apprenant = :id_apprenant AND session.date_debut >= DATE(NOW())");    
...
if (count($enrollments) > 0):
    ...
    Vous n'êtes inscrit à aucune session pour cette information.    </div>
<?php endif; ?>
